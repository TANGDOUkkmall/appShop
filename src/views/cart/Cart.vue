          ...
          >
            <div class="left">
              <a
                ...
                @click="singerGoodsSelected(goods.id)"
              ></a>
            </div>
            <div class="center">
...
.cartCheckBox {
  background: url("https://img.ddimg.mobi/product/2f9f42dd5c3311558682395205.jpg!deliver.product.list")
    no-repeat;
